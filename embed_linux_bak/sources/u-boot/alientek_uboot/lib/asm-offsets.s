...
@ -I ./arch/arm/mach-stm32mp/include
@ -iprefix /home/share/samba/mp157_linux/alientek/tools/gcc-arm-9.2-2019.12-x86_64-arm-none-linux-gnueabihf/bin/../lib/gcc/arm-none-linux-gnueabihf/9.2.1/
@ -isysroot /home/share/samba/mp157_linux/alientek/tools/gcc-arm-9.2-2019.12-x86_64-arm-none-linux-gnueabihf/bin/../arm-none-linux-gnueabihf/libc
@ -D __KERNEL__ -D __UBOOT__ -D __ARM__ -D __LINUX_ARM_ARCH__=7
@ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /home/share/samba/mp157_linux/alientek/tools/gcc-arm-9.2-2019.12-x86_64-arm-none-linux-gnueabihf/bin/../lib/gcc/arm-none-linux-gnueabihf/9.2.1/include
...
@ 启用的选项：  -faggressive-loop-optimizations -fassume-phsa
...
.LASF32:
	.ascii	"flash_id\000"
.LASF177:
	.ascii	"/home/share/samba/embed_linux/embeded_linux/sources"
	.ascii	"/u-boot/alientek_uboot\000"
.LASF88:
	.ascii	"ih_time\000"
.LASF73:
